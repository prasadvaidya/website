...
Psychologists call this cognitive offloading, and the useful definition comes from Evan Risko and Sam Gilbert: taking a physical action in the world in order to reduce the mental effort a task demands. Tilting your head to read rotated text is offloading. So is using your fingers to count.

A few findings from that literature are worth knowing:

**People offload more when they trust their memory less.** Gilbert's work on intention offloading found that the decision to set an external reminder tracks how confident you feel about remembering, not just how important the thing is. That matters because confidence is not well calibrated. You will happily carry six things in your head on a good morning and drop four of them by 3pm.
...
A task manager will faithfully tell you tomorrow that "fix the billing proration bug" is still open. It will not tell you that you had already ruled out the calculation logic and were halfway through checking currency precision. So you rebuild that, and rebuilding it is the tax.
